                    ...
                    <div class="col-md-12">
                        <div class="mu-author-area">
                            ...
                            <div class="mu-heading-area">
                                <h2 class="mu-heading-title">STIV JOBS haqida</h2>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mu-author-image">
                                            <img src="/images/stivjobs.jpg" style='width:100%;'
                                                alt="Author Image">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mu-author-info">
                                            <h3>STIV JOBS</h3>
                                            <p>Steve Jobs 1955-yil 24-fevralda Kaliforniya shtatidagi Mountain View
                                                shaharchasida tugʻilgan. Uning yoshlik va oʻsmirlik yillari shu yerda
                                                oʻtgan.</p>

                                            <p>Jobsning haqiqiy ota-onasi yosh talabalar boʻlgani va oila qurmagani
                                                uchun goʻdakni boqib olish uchun berib yuborishadi. Pol va Klara Jobslar
                                                esa uni boqib oladi!</p>
                                            <img class="mu-author-sign" src="/images/author-signature.png"
                                                alt="Author Signature">

                                            <div class="mu-author-social">
                                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                                    data-target="#myModal">Buyurtma berish</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
